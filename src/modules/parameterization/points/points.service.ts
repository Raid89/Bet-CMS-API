...
import { Points } from './points.schema';
...
export class PointsService {
    ...
    constructor(
        @InjectModel(Points.name) private pathsModel: Model<Points>,
    ...
    public async createPath(pathData: CreatePointDto) {
        try {
    ...
    public async updatePath(id: string, pathData: UpdatePointDto) {
        try {
