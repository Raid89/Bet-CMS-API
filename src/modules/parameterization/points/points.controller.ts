...
import { CreatePointDto, UpdatePointDto } from './dto/points.dto';
...
export class PointsController {
    ...
    async getAllPaths(){
            return await this.pointsService.getAllPaths();
    }
    ...
    async getPathById( @Param('id') id: string){
            return await this.pointsService.getPathById(id);
    }
    ...
    async getActivePaths(){
            return await this.pointsService.getActivePaths();
    }
    ...
    async createPromo(@Body() pathData: CreatePointDto){
        return await this.pointsService.createPath(pathData);
    }
    ...
    @HttpCode(HttpStatus.CREATED)
    async updatePromo(@Body() pathData: UpdatePointDto, @Param('id') id: string){
        return await this.pointsService.updatePath(id, pathData);
    }
    ...
    async deletePath(@Param('id') id: string){
        return await this.pointsService.deletePath(id);
    }
}